package br.com.digitalhouse.googlemaps_aula;
...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getDeviceLocation() {
        try {
            ...
            Log.e("EU FALEI FATIMA EU ", e.getMessage());
        }
    }
    ...
    public void findHugo() {
        ...
        BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.balaoapp);
        LatLng hugo = new LatLng(-34,151);

        MarkerOptions markerOptions = new MarkerOptions()
                .position(hugo)
                .title("Hugo esta aqui")
                .snippet("MIlho arroz eu sei que voce fez verao passado")
                .icon(icon);
